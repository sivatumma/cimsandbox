enyo.kind({
    ...
    fit: true,
    components: [{name:"ErrorConditionMessages",style:"color:red; font-weight:bold; padding:10px;"},{
        name: "menuArea",
        kind: 'Scroller',
        touch: true,
        fit: true,
    ...
    traverse: function(o) {
        ...
        treeComponentJson.content = o.providerName + " <a href='catalogues/" + o.catalogLink + "'>Docs<img src='assets/pdf.png'/></a>";
